      ...
      <nav class="mt-2">
        ...
        <?php if($_SESSION['login_type'] == 1): ?>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./schedule/index.php" class="nav-link nav-new_document tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Calendar</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=Forms_to_Sign" class="nav-link nav-new_document tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Forms to Sign</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=Forms_to_Fill_Out" class="nav-link nav-document_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=generate_payment_file" class="nav-link nav-new_document tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Generate Payment File</p>
                </a>
              </li>
            </ul>
          </li>
